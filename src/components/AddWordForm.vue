  ...
  <div class="adder">
    <form class="adder__form form">
      <div class="form__wrapper">
        <CustomSelect
          :options="form.languagesState.from.langs"
          v-model="form.languagesState.from.chosenValue.longString"
          :placeholder="form.languagesState.from.placeholder"
          :error="formErrors.languagesStateFromError"
          :selectedOptionWithPlaceholder="false"
          :withSearch="true"
        />
        ...
        <CustomSelect
          :options="form.languagesState.to.langs"
          v-model="form.languagesState.to.chosenValue.longString"
          :placeholder="form.languagesState.to.placeholder"
          :error="formErrors.languagesStateToError"
          :selectedOptionWithPlaceholder="false"
          :withSearch="true"
        />
      </div>
      <div class="form__box form-box">
        <input
          ...
          :class="{ 'filling--error': formErrors.wordError }"
          type="text"
          :placeholder="form.word.placeholder"
      ...
      <div class="form__box form-box">
        <input
          class="form-box__input filling filling--input filling--notblured"
          :class="{ 'filling--error': formErrors.translateError }"
          type="text"
          :placeholder="form.translate.placeholder"
          v-model="form.translate.value"
        />
      </div>
      <div class="form__box form-box">
        <input
      ...
      <CustomSelect
        :options="form.addTo.directions"
        v-model="form.addTo.chosenValue"
        :placeholder="form.addTo.placeholder"
        :error="formErrors.addToError"
        :withSearch="false"
      />
